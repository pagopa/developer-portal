...
import { staticProductTutorialPage } from "@/adapters/static/staticProductTutorialPage";
...
export const getStaticProps: GetStaticProps<ProductTutorialProps> = () => ({
  props: {
    navLinks: makeMenu(staticNav, staticProductTutorialPage.product),
    ...staticProductTutorialPage,
  }
});
