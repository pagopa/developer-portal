  ...
  app(input) {
    return {
      ...
      environment: {
        ...
        S3_PATH_TO_GITBOOK_DOCS_ASSETS:
          process.env.S3_PATH_TO_GITBOOK_DOCS_ASSETS,
        ...
        NEXT_PUBLIC_WEBINAR_QUESTION_API_KEY:
          process.env.NEXT_PUBLIC_WEBINAR_QUESTION_API_KEY,
