...
-->
    ...
    <xsl:template match="ws:port" mode="service">
        ...
        <div class="port-row port-operations">
            <div class="port-label">Operations:</div>
            <ol class="port-value">
    ...
    <xsl:template match="ws:binding|ws2:binding" mode="service">
        ...
        <xsl:if test="$real-binding/@style">
            <div class="port-row">
                <div class="port-label">Default style:</div>
                <div class="port-value">
        ...
        <xsl:if test="$real-binding/@transport|$real-binding/*[local-name() = 'protocol']">
            ...
            <div class="port-row">
                <div class="port-label">Transport protocol:</div>
                <div class="port-value">
                    <xsl:choose>
        ...
        <div class="value box" style="margin-bottom: 3px">
            ...
            <xsl:choose>
                ...
                <xsl:when test="string-length(@name) &gt; 0">
                    ...
                    <span class="operation-message-label">
                        <xsl:value-of select="@name"/>
                    </span>
...
-->
    ...
    <xsl:template match="xsd:complexType" mode="operations.message.part">
        ...
        <xsl:choose>
            ...
            <xsl:otherwise>
                ...
                <span class="type-label" style="color:blue">
    ...
    <xsl:template match="xsd:sequence" mode="operations.message.part">
        ...
        <ul class="subtypes-list" type="none">
...
-->
    ...
    <xsl:template name="render-type.write-name">
        ...
        <span class="type-label"><xsl:text> type </xsl:text></span>
