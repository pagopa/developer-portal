...
import { StrapiProduct, StrapiProducts } from '@/lib/strapi/types/product';

export function minimalProducts(): readonly StrapiProduct[] {
...
export function wrapAsPaginatedProducts(
  products: readonly StrapiProduct[]
): StrapiProducts {
  return {
    ...strapiProducts,
    data: products,
