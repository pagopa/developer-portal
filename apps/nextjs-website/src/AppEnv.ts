...
// the environment of the application contains configuration as well other
// dependencies required by the application. In other words contains all runtime
// configuration and global functions that may be mockable
export type AppEnv = {
...
// provide an AppEnv ready to be used
