  ...
  steps: [
    {
      ...
      parts: [
        ...
        {
          component: 'innerHTMLLazyLoaded',
          html: `<p>Per altre info sul certificato, <a href="/pagopa/manuali/sanp/3.4.1/appendici/connettivita" target="_blank">visita questa pagina</a>.</p>`,
        },
      ],
    },
    {
    ...
    },
    {
      ...
      parts: [
        {
          component: 'innerHTMLLazyLoaded',
          html: `<p>Procedi con i processi di pagamento secondo la documentazione che <a href="/pagopa/manuali/sanp/3.4.1/casi-duso/pagamento-di-un-avviso-presso-psp" target="_blank">trovi qui</a>.</p>`,
        },
      ],
    },
  ],
