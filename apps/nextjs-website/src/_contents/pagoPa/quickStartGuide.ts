  ...
  steps: [
    {
      ...
      parts: [
        ...
        {
          component: 'innerHTMLLazyLoaded',
          html: `<p>Per altre info sul certificato, <a href="/pago-pa/guides/sanp/appendici/connettivita" target="_blank">visita questa pagina</a>.</p>`,
        },
      ],
    },
    {
    ...
    },
    {
      ...
      parts: [
        {
          component: 'innerHTMLLazyLoaded',
          html: `<p>Procedi con i processi di pagamento secondo la documentazione che <a href="/pago-pa/guides/sanp/casi-duso/pagamento-di-un-avviso-presso-psp" target="_blank">trovi qui</a>.</p>`,
        },
      ],
    },
  ],
