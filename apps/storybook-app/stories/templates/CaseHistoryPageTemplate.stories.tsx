...
export const Showcase: StoryObj<typeof CaseHistoryPageTemplate> = {
  args: {
    ...
    description: 'I cittadini possono essere notificati di eventuali multe e provvedere al pagamento attraverso Lorem ipsum dolor sit amet consectetur adipiscing elit Ut et massa mi. Aliquam in hendrerit urna. Pellentesque sit amet sapien.',
    slug: 'il-processo-di-riscossione-della-tari-del-comune-di-cagliari',
    parts: [
      {
        component: 'blockRenderer',
        html: [
          {...mockTextBlock({type: 'heading', level: 2, text: 'Sottotitolo'})},
          {...mockTextBlock()},
          {...mockTextBlock()},
          {...mockImageBlock()},
          {...mockTextBlock({type: 'heading', level: 2, text: 'Sottotitolo'})},
