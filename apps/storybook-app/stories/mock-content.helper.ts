...
export function mockTextBlock(args?: {type?: 'paragraph' | 'heading' , text?: string, level?: 1 | 2 | 3 | 4 | 5 | 6 }): BlocksContent[0] {
    // const {type, text, level} = args;
...
export function mockImageBlock(url: string = DEFAUTL_IMAGE_URL): BlocksContent[0] {
    return {
        type: 'image',
        image: {
          name: 'a-image.jpg',
