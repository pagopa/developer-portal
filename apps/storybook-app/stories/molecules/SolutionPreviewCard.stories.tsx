  ...
  args: {
    ...
    steps: [
      ...
      },
      {
        ...
        products: [{ label: 'PagoPA', href: 'https://example.com' }, { label: 'IO', href: 'https://example.com' }],
      },
      {
        title: '03',
        content: 'Emissione, consegna e pagamento del verbale di contestazione',
        products: [{ label: 'PagoPA', href: 'https://example.com' }, { label: 'IO', href: 'https://example.com' }, { label: 'SEND', href: 'https://example.com' }],
      },
      {
        title: '04',
        content: 'Emissione, consegna e pagamento del verbale di contestazione',
