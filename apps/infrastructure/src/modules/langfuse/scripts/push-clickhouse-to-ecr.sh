...
# Configuration
CLICKHOUSE_VERSION="25.8.8.26-alpine"
DOCKER_HUB_IMAGE="clickhouse/clickhouse-server:${CLICKHOUSE_VERSION}"
...
echo -e "${BLUE}ClickHouse ECR Migration Script${NC}"
echo "=================================="
echo ""
...
ECR_REPO_NAME="clickhouse"
ECR_IMAGE="${ECR_REGISTRY}/${ECR_REPO_NAME}:${CLICKHOUSE_VERSION}"

echo -e "${GREEN}Step 1:${NC} Logging in to ECR..."
aws ecr get-login-password --region ${AWS_REGION} | docker login --username AWS --password-stdin ${ECR_REGISTRY}

echo -e "\n${GREEN}Step 2:${NC} Pulling ClickHouse image from Docker Hub..."
...
echo -e "\n${GREEN}✓ Success!${NC} ClickHouse image pushed to ECR:"
echo "  ${ECR_IMAGE}"
echo ""
echo "Next steps:"
