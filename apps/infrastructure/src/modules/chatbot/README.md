...
| <a name="input_ecs_monitoring"></a> [ecs\_monitoring](#input\_ecs\_monitoring) | Langfuse configuration for the AI chatbot | <pre>object({<br/>    cpu       = number<br/>    memory    = number<br/>    image_uri = string<br/>    port      = number<br/>    image_tag = string<br/>  })</pre> | n/a | yes |
| <a name="input_ecs_redis"></a> [ecs\_redis](#input\_ecs\_redis) | Redis configuration for the AI chatbot | <pre>object({<br/>    cpu       = number<br/>    memory    = number<br/>    image_uri = string<br/>    port      = number<br/>    image_tag = string<br/>  })</pre> | n/a | yes |
