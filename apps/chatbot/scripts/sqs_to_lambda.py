...
QUEUES_CONFIG = {
    "monitor": {
        ...
        "lambda_url": os.getenv("LAMBDA_MONITOR_URL", "http://monitor:8080/2015-03-31/functions/function/invocations"),
        "label": "Monitor"
    },
    "evaluate": {
        "name": os.getenv("CHB_AWS_SQS_QUEUE_EVALUATE_NAME", "chatbot-evaluate"),
        "lambda_url": os.getenv("LAMBDA_EVALUATE_URL", "http://evaluate:8080/2015-03-31/functions/function/invocations"),
        "label": "Evaluate"
    }
}
                    ...
                    "Records": [
                        {
                            ...
                            "body": message.body,
                            "attributes": message.attributes if hasattr(message, 'attributes') else {},
                            "messageAttributes": {},
